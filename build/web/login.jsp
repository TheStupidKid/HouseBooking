                        ...
                        <div class="myform form ">
                            ...
                            <form action="LoginServlet" method="post" name="login">
                                ...
                                <div class="col-md-12 mb-3">
                                    <p class="text-center">
                                        <a href="https://accounts.google.com/o/oauth2/auth?scope=profile%20email&redirect_uri=http://localhost:8080/HouseBookingSystem_SWP391/LoginGoogleServlet&response_type=code
